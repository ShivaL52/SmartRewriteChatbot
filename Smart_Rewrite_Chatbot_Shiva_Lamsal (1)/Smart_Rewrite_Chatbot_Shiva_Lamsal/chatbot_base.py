"""
Base Chatbot class for the Introduction to Artificial Intelligence NLP mini-project.
The assessment template asks the project chatbot to inherit from this class.
"""


class ChatbotBase:
    """Small reusable base class for terminal-style chatbot behaviour."""

    def __init__(self, name="Chatbot"):
        self.name = name
        self._conversation_is_active = True
    ...
    def conversation_is_active(self):
        return self._conversation_is_active

    def stop_conversation(self):
        self._conversation_is_active = False
